...
```js
console.log("sum of "+num1+" and "+nun2+" is "+nun3)
```
...
if (b <25 )
{ console.log("bottom quartily"); }
else if (25<=b<=50 )
{ console.log("lower quartily"); }
else if (50<b<=75 )
{ console.log("upper quartily"); }
else if (75<b<=100 )
{ console.log("top quartily"); }
...
```js
// var favoriteMovies = ["Harry poter" , "death race" , "The mask" , "spy" , " Iron man"];
```
