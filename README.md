...
for ( var i= Math.ceil(Math.random()) ; i <= 20 ; i++ ){
 if ( i % 2 ==0 ) { console.log('...human...why you taking pictures of me?...' + ", " + '...the catnip made me do it...') ||console.log( '...why does the red dot always get away...')  }
}
...
```js
var favoriteMovies = ['Avatar' , 'Titanic' , 'Avengers' , 'Widows' , 'Black Panther'];
```
...
ninjaTurtles = ninjaTurtles.map(function(x){ return x.toUpperCase() })
