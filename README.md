...
```js
  for(var i = 0; i < 20; i++){
   ...
   var message = ["...human...why you taking pictures of me?...", "...the catnip made me do it...", "...why does the red dot always get away..."]
   for(var i = 0; i < 20; i++){
      console.log("Love me, pet me! HSSSSSS!");
      if(i % 2 == 0){  
...
```js
var ninjaTurtles = ['Donatello', 'Leonardo', 'Raphael', 'Michaelangelo'];
// your answer here	for(var i = 0; i < ninjaTurtles.length; i++){
 console.log(ninjaTurtles[i][2].toUpperCase());
    for(var j = 0; j < ninjaTurtles.length; j++){
  ninjaTurtles[i][j]
  }
}
