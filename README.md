...
```js
 for(var i=0;i<=20;i++){ 
    ...
    if(i%2==0){
      List=["...human...why you taking pictures of me?...","...the catnip made me do it...","...why does the red dot always get away..."];
      console.log('Love me, pet me! HSSSSSS! '+List[Math.floor(Math.random()*3)]);
    }
    else 
...
```js
  var favoriteMovies=['Mission Impossible','Spider Man','Green Book','Italian Job','Captain Marvel'];
```
